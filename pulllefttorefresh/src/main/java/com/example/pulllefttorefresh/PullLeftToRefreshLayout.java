...
public class PullLeftToRefreshLayout extends FrameLayout {
    ...
    private static final Interpolator ANIMATION_INTERPOLATOR = new LinearInterpolator();//匀速加速器
    ...
    private static final int ROTATION_ANGLE = 180;//箭头旋转的角度

    private static String SCAN_MORE;//左拉时的提示语
    private static String RELEASE_SCAN_MORE;//释放的提示语
     ...
     */
    private int moreViewMarginRight;//文字离屏幕右边的间距
    private int footerViewBgColor; //左滑时footview的背景颜色
